...
public class Order1 {
	...
	@Autowired
	@OneToOne
	private User1 user1=ConfigBean.getUser1();
	...
	public Order1(String Statusmsg,Cart cart){
		this.user1=ConfigBean.getUser1();
	...
	public long calculateTotalPrice() {
		this.totalPrice=0l;
		productsAndQty.forEach(pAndq->this.totalPrice+=(pAndq.getQty()*pAndq.getProduct().get_price()));
		return totalPrice;
	}
