...
public class CartServiceImpl {
	...
	public Set<ProductAndQty> OrderProducts(long productId)
	{
		...
		ProductAndQty productAndQty=(ProductAndQty)ProductsAndQty.parallelStream().filter(pAndq->pAndq.getId()==productId).toArray()[0];
	...
	public Boolean checkIfCurrentProductExistsinCart(Long productId,)
	...
	public Set<ProductAndQty> OrderProducts(long productId,long qty)
	{
		...
		ProductAndQty productAndQty=new ProductAndQty(product,qty);
		ProductsAndQty.add(productAndQty);
		cart.setProductsAndQty(ProductsAndQty);
		productAndQtyServiceImpl.save(productAndQty);
		productServiceImpl.save(product);
